...
import domain.service.interfaces.area_history.GetListAreaHistoryService;
 ...
 */
@Service
public class GetListAreaHistoryServiceImpl implements GetListAreaHistoryService {
    @Autowired
